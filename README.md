...
[Ubuntu 26.04 LTS (Resolute Raccoon)](https://cloud-images.ubuntu.com/resolute/current/)
...
`cidata` seed built from [seed/user-data.pkrtpl.hcl](./seed/user-data.pkrtpl.hcl)
and [seed/meta-data](./seed/meta-data). There is no unattended installer step:
